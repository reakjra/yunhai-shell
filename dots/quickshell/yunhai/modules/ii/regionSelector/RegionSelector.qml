...
Scope {
    ...
    GlobalShortcut {
        ...
        onPressed: { if (Config.options.panelFamily !== "ii") return; root.screenshot() }
    }
    GlobalShortcut {
        name: "regionSearch"
        description: "Searches the selected region"
        onPressed: { if (Config.options.panelFamily !== "ii") return; root.search() }
    }
    GlobalShortcut {
        name: "regionOcr"
        description: "Recognizes text in the selected region"
        onPressed: { if (Config.options.panelFamily !== "ii") return; root.ocr() }
    }
    GlobalShortcut {
        name: "regionRecord"
        description: "Records the selected region"
        onPressed: { if (Config.options.panelFamily !== "ii") return; root.record() }
    }
    GlobalShortcut {
        name: "regionRecordWithSound"
        description: "Records the selected region with sound"
        onPressed: { if (Config.options.panelFamily !== "ii") return; root.recordWithSound() }
    }
    GlobalShortcut {
        name: "regionTranslate"
        description: "Translates text in the selected region"
        onPressed: { if (Config.options.panelFamily !== "ii") return; root.translate() }
    }
}
