...
AbstractOverlayWidget {
    ...
    property bool showOffscreenButton: Config.options?.overlay.showOffscreenButton ?? true
    ...
    property bool allowOffscreen: false
    ...
    drag {
        minimumX: root.allowOffscreen ? -root.width + root.resizeMargin : 0
        minimumY: root.allowOffscreen ? -root.height + root.resizeMargin : 0
        maximumX: root.allowOffscreen ? (root.parent?.width ?? 0) - root.resizeMargin : (root.parent?.width ?? 0) - root.width
        maximumY: root.allowOffscreen ? (root.parent?.height ?? 0) - root.resizeMargin : (root.parent?.height ?? 0) - root.height
    }
    ...
    DragHandler {
        ...
        xAxis.minimum: root.allowOffscreen ? -root.width + root.resizeMargin : 0
        xAxis.maximum: root.allowOffscreen ? (root.parent?.width ?? 0) - root.resizeMargin : (root.parent?.width ?? 0) - root.width
        yAxis.minimum: root.allowOffscreen ? -root.height + root.resizeMargin : 0
        yAxis.maximum: root.allowOffscreen ? (root.parent?.height ?? 0) - root.resizeMargin : (root.parent?.height ?? 0) - root.height
    }
    ...
    Rectangle {
        ...
        color: ColorUtils.transparentize(
            ...
            (root.fancyBorders && GlobalStates.overlayOpen) ? 0 : 1
        )
        radius: root.radius
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    TitlebarButton {
                        visible: root.showOffscreenButton
                        materialSymbol: "monitor"
                        toggled: root.allowOffscreen
                        onClicked: root.allowOffscreen = !root.allowOffscreen
                        StyledToolTip {
                            text: Translation.tr("Allow offscreen")
                        }
                    }
