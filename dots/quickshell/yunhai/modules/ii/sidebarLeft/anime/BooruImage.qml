...
Button {
    ...
    property bool isVideo: ["mp4", "webm", "avi", "mov"].includes(fileExt)
    property bool isGif: fileExt === "gif"
    property string localSource: ""
    property bool needsCurlDownload: manualDownload && !isVideo
    ...
    contentItem: Item {
        ...
        Loader {
            id: mediaLoader
            anchors.fill: parent
            sourceComponent: root.isVideo ? videoComponent : root.isGif ? gifComponent : imageComponent
        }
        ...
        Component {
            ...
            Item {
                ...
                MaterialSymbol {
                    ...
                    iconSize: 32
                    text: videoPlayer.playbackState === MediaPlayer.PlayingState ? "" : "play_arrow"
                    color: "white"
                    opacity: 0.8
