...
AbstractBackgroundWidget {
    ...
    readonly property bool shouldShow: (!Config.options.background.widgets.clock.showOnlyWhenLocked || GlobalStates.screenLocked) && !GlobalStates.desktopLockClockHidden
    property bool wallpaperSafetyTriggered: false
    needsColText: clockStyle === "digital" || clockStyle === "lunae"
    ...
    Column {
        ...
        FadeLoader {
            id: lunaeClockLoader
            anchors.horizontalCenter: parent.horizontalCenter
            shown: root.clockStyle === "lunae" && (root.shouldShow)
            fade: false
            sourceComponent: LunaeClock {
                colText: root.colText
            }
        }
        StatusRow {
    ...
    component StatusRow: Item {
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                ClockStatusText {
                    id: lockStatusText
                    shown: GlobalStates.screenLocked && Config.options.lock.showLockedText && !GlobalStates.desktopLockClockHidden
                    statusIcon: "lock"
