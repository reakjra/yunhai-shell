    ...
    ScreencopyView {
        ...
        DragManager {
            ...
            onDragReleased: (diffX, diffY) => {
                ...
                const command = ScreenshotAction.getCommand(dragArea.selectionX //
                , dragArea.selectionY //
                , dragArea.selectionWidth //
                , dragArea.selectionHeight //
                , root.screenshotPath //
                , screenshotAction //
                , screenshotDir //
                , root.monitorScale //
                , root.hyprlandMonitor.x //
                , root.hyprlandMonitor.y); // yo wtf is this formatting qmlls do be funnie
