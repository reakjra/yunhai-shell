...
Singleton {
    ...
    property bool isNewHyprlandInstance: previousHyprlandInstanceSignature !== states.idle.hyprlandInstanceSignature

    onReadyChanged: {
        root.previousHyprlandInstanceSignature = root.states.idle.hyprlandInstanceSignature
        root.states.idle.hyprlandInstanceSignature = Quickshell.env("HYPRLAND_INSTANCE_SIGNATURE") || ""
    }
    ...
    FileView {
        ...
        adapter: JsonAdapter {
            ...
            property JsonObject idle: JsonObject {
                ...
                // why the fuck it doesnt work anymore as a toplevel string what the fuck i hate all of this omfg
                property string hyprlandInstanceSignature: ""
            }
