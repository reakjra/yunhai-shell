...
Singleton {
    ...
    m3colors: QtObject {
        ...
        property color kdeViewBg: "#141316"
        property color kdeViewAltBg: "#1e1d20"
        property color kdeWindowBg: "#1e1d20"
        property color kdeWindowAltBg: "#464447"
        property color kdeButtonBg: "#2b2a2b"
        property color kdeButtonAltBg: "#464447"
        property color kdeSelectionBg: "#303747"
        property color kdeSelectionText: "#ffffff"
        property color kdeTitlebarBg: "#343235"
        property color kdeTitlebarText: "#e6e1e4"
        property color kdeInactiveTitlebarBg: "#4a4854"
        property color kdeInactiveTitlebarText: "#e6e0f0"
        property color kdeViewText: "#e6e1e4"
        property color kdeWindowText: "#c9c5c8"
        property color kdeInactiveText: "#939093"
        property color kdeLinkText: "#b7bfd4"
        property color kdeVisitedText: "#ebb2ff"
        property color kdeErrorText: "#ffb3b4"
        property color kdeWarningText: "#ffb286"
        property color kdeSuccessText: "#00e479"
        property color kdeAccent: "#3d475d"
        property color kdeTooltipBg: "#1e1d20"
        property color kdeTooltipText: "#e6e1e4"
        property color kdeComplementaryBg: "#1e1d20"
        property color kdeComplementaryText: "#c9c5c8"
        property color gtkAccent: "#c9c4d6"
        property color gtkAccentFg: "#312f3c"
        property color gtkWindowBg: "#141315"
        property color gtkWindowFg: "#e5e1e3"
        property color gtkHeaderbarBg: "#141315"
        property color gtkHeaderbarFg: "#e5e1e3"
        property color gtkViewBg: "#141315"
        property color gtkViewFg: "#e5e1e3"
        property color gtkCardBg: "#141315"
        property color gtkCardFg: "#e5e1e3"
        property color gtkPopoverBg: "#141315"
        property color gtkPopoverFg: "#e5e1e3"
    }
