    ...
    contentItem: Rectangle {
        ...
        ColumnLayout {
            ...
            ContextMenuItem {
                iconName: "undo"
                label: "Undo"
                onClicked: { root.textField.undo(); root.close(); }
            }

            ContextMenuItem {
                iconName: "redo"
                label: "Redo"
                onClicked: { root.textField.redo(); root.close(); }
            }
            ...
            ContextMenuItem {
                iconName: "cut"
                label: "Cut"
                enabled: root.textField.selectedText.length > 0
                onClicked: { root.textField.cut(); root.close(); }
            }
            ...
            ContextMenuItem {
                ...
                label: "Copy"
                enabled: root.textField.selectedText.length > 0
                onClicked: { root.textField.copy(); root.close(); }
            }

            ContextMenuItem {
                iconName: "content_paste"
                label: "Paste"
                onClicked: { root.textField.paste(); root.close(); }
            }
            ...
            ContextMenuItem {
                ...
                label: "Delete"
                enabled: root.textField.selectedText.length > 0
                onClicked: { root.textField.remove(root.textField.selectionStart, root.textField.selectionEnd); root.close(); }
            }
            ...
            ContextMenuItem {
                iconName: "select_all"
                label: "Select All"
                onClicked: { root.textField.selectAll(); root.close(); }
            }
        }
    }
