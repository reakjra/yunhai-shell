...
GroupButton {
    ...
    contentItem: RowLayout {
        ...
        Loader {
            ...
            visible: active
            property bool isCustomIcon: root.buttonIcon === "spark" || root.buttonIcon === "distro"
            sourceComponent: isCustomIcon ? customIconComponent : materialSymbolComponent
            ...
            Component {
                ...
                Item {
                    implicitWidth: customIcon.width
                    CustomIcon {
                        id: customIcon
                        anchors.centerIn: parent
                        width: Appearance.font.pixelSize.larger
                        height: Appearance.font.pixelSize.larger
                        source: root.buttonIcon === "distro" ? SystemInfo.distroIcon : `${root.buttonIcon}-symbolic`
                        colorize: true
                        color: root.toggled ? Appearance.colors.colOnPrimary : Appearance.colors.colOnSecondaryContainer
                    }
                }
