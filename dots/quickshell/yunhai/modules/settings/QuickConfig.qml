...
ContentPage {
    ...
    component SmallLightDarkPreferenceButton: RippleButton {
        ...
        onClicked: MaterialThemeLoader.switchDarkLightMode(dark)
        contentItem: Item {
    ...
    ContentSection {
        ...
        RowLayout {
            ...
            ColumnLayout {
                RippleButtonWithIcon {
                    ...
                    StyledToolTip {
                        text: Translation.tr("Random SFW Anime wallpaper from Konachan\nImage is saved to %1").arg(Config.options.wallpaperSelector.downloadPath)
                    }
                }
                RippleButtonWithIcon {
                    enabled: !randomWallProc.running
        ...
        ConfigSelectionArray {
            ...
            onSelected: newValue => {
                ...
                MaterialThemeLoader.resetOverridesUnlessPreserved();
                Quickshell.execDetached(["bash", "-c", `${Directories.wallpaperSwitchScriptPath} --type ${newValue} --noswitch`]);
                MaterialThemeLoader.scheduleForceReload();
            }
            options: [
                {
        ...
        ConfigRow {
            ...
            ConfigSwitch {
                ...
                text: Translation.tr("Auto transparency")
    ...
    ContentSection {
        ...
        Loader {
            ...
            visible: active
            Layout.fillWidth: true
            source: active ? Quickshell.shellPath(`modules/${Config.options.panelFamily}/settings/sections/QuickSections.qml`) : ""
        }
        ...
        ConfigRow {
            ContentSubsection {
                ...
                ConfigSelectionArray {
                    currentValue: Config.options.screen.fakeScreenRounding
                    onSelected: newValue => {
                        Config.options.screen.fakeScreenRounding = newValue;
                    }
                    options: [
                        {
        ...
        ConfigSpinBox {
            visible: Config.options.screen.fakeScreenRounding === 3
            icon: "line_weight"
            text: Translation.tr("Wrapped frame thickness")
            value: Config.options.screen.wrappedFrameThickness
            from: 5
            to: 25
            stepSize: 1
            onValueChanged: {
                Config.options.screen.wrappedFrameThickness = value;
            }
        }
    }
    ...
    NoticeBox {
        Layout.fillWidth: true
        text: Translation.tr('Not all options are available in this app. The rest live in %1, which you can edit directly.').arg(Directories.familyConfigPath(Config.options.panelFamily))
        ...
        RippleButtonWithIcon {
            ...
            onClicked: {
                ...
                Quickshell.clipboardText = FileUtils.trimFileProtocol(Directories.familyConfigPath(Config.options.panelFamily));
