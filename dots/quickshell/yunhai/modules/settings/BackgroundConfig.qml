...
ContentPage {
    ...
    ContentSection {
        ...
        readonly property bool lunaePresent: stylePresent("lunae")
            ...
            ContentSubsection {
                ...
                ConfigSelectionArray {
                    ...
                    options: [
                        ...
                        {
                            displayName: Translation.tr("Lunae"),
                            icon: "calendar_month",
                            value: "lunae"
                        }
                    ]
        ...
        ContentSubsection {
            visible: settingsClock.digitalPresent || settingsClock.lunaePresent
    ...
    ContentSection {
        ...
        readonly property bool digitalPresent: Config.options.background.widgets.weather.style === "digital"
        ...
        ContentSubsection {
            visible: settingsWeather.digitalPresent
            title: Translation.tr("Digital weather settings")
            tooltip: Translation.tr("Font width and roundness settings are only available for some fonts like Google Sans Flex")
            ...
            ConfigRow {
                ...
                ConfigSwitch {
                    ...
                    text: Translation.tr("Show city")
                    checked: Config.options.background.widgets.weather.digital.showCity
                    onCheckedChanged: {
                        Config.options.background.widgets.weather.digital.showCity = checked;
                    }
                }
                ConfigSwitch {
                    buttonIcon: "cloud"
                    text: Translation.tr("Show weather icon")
                    checked: Config.options.background.widgets.weather.digital.showIcon
                    onCheckedChanged: {
                        Config.options.background.widgets.weather.digital.showIcon = checked;
                    }
                }
            }

            ConfigSwitch {
                visible: Config.options.background.widgets.weather.digital.showCity
                buttonIcon: "vertical_align_bottom"
                text: Translation.tr("City on separate line")
                checked: Config.options.background.widgets.weather.digital.cityBelow
                onCheckedChanged: {
                    Config.options.background.widgets.weather.digital.cityBelow = checked;
                }
            }
            ...
            MaterialTextArea {
                Layout.fillWidth: true
                placeholderText: Translation.tr("Font family")
                text: Config.options.background.widgets.weather.digital.font.family
                wrapMode: TextEdit.Wrap
                onTextChanged: {
                    Config.options.background.widgets.weather.digital.font.family = text;
                }
            }

            ConfigSlider {
                text: Translation.tr("Font weight")
                value: Config.options.background.widgets.weather.digital.font.weight
                usePercentTooltip: false
                buttonIcon: "format_bold"
                from: 1
                to: 1000
                stopIndicatorValues: [350]
                onValueChanged: {
                    Config.options.background.widgets.weather.digital.font.weight = value;
                }
            }

            ConfigSlider {
                text: Translation.tr("Font size")
                value: Config.options.background.widgets.weather.digital.font.size
                usePercentTooltip: false
                buttonIcon: "format_size"
                from: 50
                to: 700
                stopIndicatorValues: [90]
                onValueChanged: {
                    Config.options.background.widgets.weather.digital.font.size = value;
                }
            }

            ConfigSlider {
                text: Translation.tr("Font width")
                value: Config.options.background.widgets.weather.digital.font.width
                usePercentTooltip: false
                buttonIcon: "fit_width"
                from: 25
                to: 125
                stopIndicatorValues: [100]
                onValueChanged: {
                    Config.options.background.widgets.weather.digital.font.width = value;
                }
            }
            ConfigSlider {
                text: Translation.tr("Font roundness")
                value: Config.options.background.widgets.weather.digital.font.roundness
                usePercentTooltip: false
                buttonIcon: "line_curve"
                from: 0
                to: 100
                onValueChanged: {
                    Config.options.background.widgets.weather.digital.font.roundness = value;
                }
            }
        }
    }
