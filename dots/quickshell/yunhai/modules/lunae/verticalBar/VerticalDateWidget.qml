...
Item {
    ...
    property var dayOfMonth: DateTime.shortDate.split(/[-\/]/)[0]
    ...
    Item {
        ...
        Shape {
            ...
            ShapePath {
                strokeWidth: 1.2
                strokeColor: Config.options.lunae.colorful ? Appearance.colors.colTertiary : Appearance.colors.colSubtext
