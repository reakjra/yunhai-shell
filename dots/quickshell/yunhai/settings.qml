...
ApplicationWindow {
    ...
    // icon (56) + spacing (20) + text + padding (20)
    readonly property real navRailExpandedWidth: 96 + navTextMetrics.width
    TextMetrics {
        id: navTextMetrics
        font.pixelSize: 14
        text: "Services" // Longest English label by character count, replace if translation is wider
    }

    visible: true
    onClosing: Qt.quit()
    title: `${PanelFamilies.metaFor(Config.options?.panelFamily)?.name ?? "Illogical Impulse"} Settings`
    ...
    ColumnLayout {
        ...
        RowLayout { // Window content with navigation rail and content pane
            ...
            Item {
                ...
                Layout.fillHeight: true
                Layout.margins: 5
                implicitWidth: navRail.expanded ? root.navRailExpandedWidth : fab.baseSize
                ...
                NavigationRail { // Window content with navigation rail and content pane
                    ...
                    FloatingActionButton {
                        ...
                        downAction: () => {
                            Qt.openUrlExternally(Directories.globalConfigPath);
                        }
                        altAction: () => {
                            Quickshell.clipboardText = CF.FileUtils.trimFileProtocol(Directories.globalConfigPath);
                            fab.justCopied = true;
            ...
            Rectangle { // Content container
                ...
                Loader {
                    ...
                    active: Config.ready && !root.ownChrome
                    Component.onCompleted: {
