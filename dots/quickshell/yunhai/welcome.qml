...
ApplicationWindow {
    ...
    title: Translation.tr("yunhai Welcome")
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            ContentPage {
                ...
                ContentSection {
                    icon: "dashboard"
                    title: Translation.tr("Panel families")

                    StyledText {
                        Layout.fillWidth: true
                        text: Translation.tr("Everything above configures Illogical Impulse, the shell you're on right now. Yunhai also ships two shells of its own, each with its own settings, check them out:")
                        color: Appearance.colors.colOnLayer0
                    ...
                    Flow {
                        ...
                        RippleButtonWithIcon {
                            ...
                            mainText: Translation.tr("Switch panel family")
                            onClicked: {
                                Quickshell.execDetached(["qs", "-p", Quickshell.shellPath(""), "ipc", "call", "panelFamilyPicker", "toggle"]);
                            }
                        }
                    }
                }
                ...
                ContentSection {
                    ...
                    StyledText {
                        Layout.fillWidth: true
                        text: Translation.tr("yunhai is a fork of end-4's illogical-impulse, so the docs below are theirs.")
