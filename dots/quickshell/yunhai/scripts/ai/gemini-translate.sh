...
SHELL_CONFIG_DIR="$XDG_CONFIG_HOME/yunhai"
SHELL_CONFIG_FILE="${SHELL_CONFIG_DIR}/global.json"
...
# Get API key
API_KEY=$(secret-tool lookup 'application' 'yunhai-shell' | jq -r '.apiKeys.gemini')
